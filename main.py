...
VT_API_KEY = "5acd22b5ba0483eed8004ac5d68a99ca5339658e5bf1d0b819146625caf1aafd"
...
class CyberAnalyzerApp(ctk.CTk):
    ...
    def save_pdf(self):
        ...
        # صورة المعاينة (Sandbox Preview)
        y_position -= 30 # مسافة قبل الصورة
        if os.path.exists("screenshots/preview.png"):
            c.setFillColor(colors.black)
            c.setFont("Helvetica-Bold", 14)
            c.drawString(50, y_position, "Visual Evidence (Sandbox Preview):")
            y_position -= 280 # حجز مساحة للصورة (الصورة هترسم في المساحة دي)
